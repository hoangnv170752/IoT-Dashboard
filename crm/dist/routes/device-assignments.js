...
export async function deviceAssignmentRoutes(fastify) {
    // GET /device-assignments
    fastify.get('/device-assignments', {
    ...
    fastify.get('/device-assignments/:id', {
        preHandler: [authenticate],
        schema: {
            tags: ['Device Assignments'],
    ...
    fastify.get('/device-assignments/by-device/:thingsboardDeviceId', {
        preHandler: [authenticate],
        schema: {
            tags: ['Device Assignments'],
    ...
    fastify.post('/device-assignments', {
        ...
        const { thingsboardDeviceId, deviceName, deviceType, companyId, notes } = request.body;
    ...
    fastify.put('/device-assignments/:id', {
        preHandler: [authenticate, requireRole('tenant_admin', 'tenant_user')],
        schema: {
            tags: ['Device Assignments'],
    ...
    fastify.delete('/device-assignments/:id', {
...
//# sourceMappingURL=device-assignments.js.map