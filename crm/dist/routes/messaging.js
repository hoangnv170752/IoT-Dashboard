...
export async function messagingRoutes(fastify) {
    ...
    fastify.get('/messaging/users/search', {
    ...
    fastify.get('/messaging/conversations', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
    ...
    fastify.post('/messaging/conversations', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
    ...
    fastify.get('/messaging/conversations/:id', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
    ...
    fastify.post('/messaging/conversations/:id/messages', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
    ...
    fastify.put('/messaging/conversations/:id/read', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
    ...
    fastify.get('/messaging/unread-count', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
    ...
    fastify.post('/messaging/support', {
        preHandler: [authenticate],
        schema: {
            tags: ['Messaging'],
