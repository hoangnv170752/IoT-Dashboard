...
export async function createTenantNotification(tenantId, type, title, message, data, actionUrl) {
...
export const NotificationHelpers = {
    ...
    async userInvited(userId, tenantName) {
    ...
    async contractStatusChanged(userId, contractNumber, newStatus, contractId) {
        return createNotification({
            userId,
            type: 'info',
    ...
    async ticketCreated(userId, ticketNumber, ticketId) {
        return createNotification({
            userId,
            type: 'info',
    ...
    async ticketResolved(userId, ticketNumber, ticketId) {
        return createNotification({
            userId,
            type: 'success',
    ...
    // Device alert
    async deviceAlert(userId, deviceName, alertMessage, severity) {
        const typeMap = {
            info: 'info',
            warning: 'warning',
            critical: 'error',
    ...
    async subscriptionExpiring(userId, daysRemaining, planName) {
        return createNotification({
            userId,
            type: 'warning',
    ...
    // Payment failed
    async paymentFailed(userId, amount, currency) {
        return createNotification({
            userId,
            type: 'error',
    ...
    // Plan limit warning
    async planLimitWarning(userId, resource, current, limit) {
