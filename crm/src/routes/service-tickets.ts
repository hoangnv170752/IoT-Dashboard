...
export async function serviceTicketRoutes(fastify: FastifyInstance) {
  // GET /service-tickets
  ...
  fastify.get<{ Params: ServiceTicketParams }>(
    '/service-tickets/:id',
    {
      preHandler: [authenticate],
      schema: {
  ...
  fastify.post<{ Body: ServiceTicketBody }>(
    '/service-tickets',
    {
      preHandler: [authenticate],
      schema: {
  ...
  fastify.put<{ Params: ServiceTicketParams; Body: Partial<ServiceTicketBody> }>(
    '/service-tickets/:id',
    {
    ...
    async (request, reply) => {
      ...
      const resolvedAt =
        (status === 'resolved' || status === 'closed') && existing.status !== 'resolved' && existing.status !== 'closed'
          ? new Date()
          : undefined;
  ...
  fastify.delete<{ Params: ServiceTicketParams }>(
    '/service-tickets/:id',
    {
