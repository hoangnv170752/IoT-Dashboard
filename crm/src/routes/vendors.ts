...
export async function vendorRoutes(fastify: FastifyInstance) {
  ...
  fastify.get<{ Params: VendorParams }>(
    '/vendors/:id',
    {
      schema: {
        tags: ['Vendors'],
  ...
  fastify.put<{ Params: VendorParams; Body: Partial<VendorBody> & { status?: VendorStatus } }>(
    '/vendors/:id',
    {
      preHandler: [requireTenantAdmin],
      schema: {
  ...
  fastify.delete<{ Params: VendorParams }>(
    '/vendors/:id',
    {
      preHandler: [requireTenantAdmin],
      schema: {
  ...
  fastify.post<{ Params: VendorParams; Body: VendorContactBody }>(
    '/vendors/:id/contacts',
    {
      preHandler: [requireTenantAdmin],
      schema: {
